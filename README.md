...
### Automatic poToken generation

JavaTube has the ability to generate the poToken automatically using javafx, all you need to do is pass a client that requires the poToken and JavaTube will do the rest:
...
```
javafx will run [BgUtils](https://github.com/LuanRT/BgUtils), responsible for interacting with BotGuard.
